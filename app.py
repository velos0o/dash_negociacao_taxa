...
st.set_page_config(
    page_title='Dashboard de Negociação',
    page_icon='src/assets/logo.svg',  # Usando o logo como favicon
    layout='wide',
...
tipo_relatorio = st.sidebar.selectbox(
    "Dashboards",
    ["Selecione uma opção", "Dashboard de Negociação", "Análise de Taxas"]
)
...
def main():
    try:
        if tipo_relatorio == "Dashboard de Negociação":
            Dashboard.render()
        elif tipo_relatorio == "Análise de Taxas":
